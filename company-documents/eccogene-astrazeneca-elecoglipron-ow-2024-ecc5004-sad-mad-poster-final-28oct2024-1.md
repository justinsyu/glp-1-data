---
layout: document
title: Safety, Tolerability and Pharmacokinetics of AZD/ECC5004, an Oral Small Molecule
  GLP-1 Receptor Agonist
permalink: /company-documents/eccogene-astrazeneca-elecoglipron-ow-2024-ecc5004-sad-mad-poster-final-28oct2024-1/
company: Eccogene / AstraZeneca
company_slug: eccogene-astrazeneca
program: Elecoglipron / ECC5004 / AZD5004
program_slug: elecoglipron
indication: Obesity; T2D
year: ''
conference: ''
document_type: Presentation/Poster
source_file: OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1.pdf
pdf_url: /companies/eccogene_astrazeneca/elecoglipron/presentations_posters/OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1.pdf
plain_text_url: /plain-text/eccogene-astrazeneca-elecoglipron-ow-2024-ecc5004-sad-mad-poster-final-28oct2024-1.txt
description: Parsed presentation/poster source document for Eccogene / AstraZeneca.
---
...
| Panel A: Insulin Secretion<br/>Time (min)  | Panel A: Insulin Secretion<br/>Vehicle (µU/mL) | Panel A: Insulin Secretion<br/>ECC5004 33 µg/kg (µU/mL) | Panel A: Insulin Secretion<br/>ECC5004 33 µg/kg (µU/mL) | Panel A: Insulin Secretion<br/>ECC5004 33 µg/kg (µU/mL) | Panel A: Insulin Secretion<br/>ECC5004 33 µg/kg (µU/mL) | Panel A: Insulin Secretion<br/>ECC5004 33 µg/kg (µU/mL) | Panel A: Insulin Secretion<br/>ECC5004 33 µg/kg (µU/mL) |
| ------------------------------------------ | ---------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------- |
| 0                                          | 100                                            | 100                                                     |                                                         |                                                         |                                                         |                                                         |                                                         |
| 15                                         | 200                                            | 1200                                                    |                                                         |                                                         |                                                         |                                                         |                                                         |
| 30                                         | 150                                            | 600                                                     |                                                         |                                                         |                                                         |                                                         |                                                         |
...
```mermaid
graph TD
    subgraph Part1 [Part 1: SAD in healthy participants]
        A1[Cohort A1 n=8; A/Pbo=6/2] --> A1P1[P1: 1 mg]
        A1P1 --> A1P2[P2: 4 mg]
        A1P2 --> A1P3[P3: 10 mg]
        A1P3 --> A1P4[P4: 25 mg]
        
        A2[Cohort A2 n=8; A/Pbo=6/2] --> A2P1[P1: 50 mg]
        A2P1 --> A2P2[P2: 100 mg]
        A2P2 --> A2P3[P3: 200 mg]
        A2P3 --> A2P4[P4: 300 mg]
    end

    subgraph Part2 [Part 2: MAD in patients with T2D]
        C1[Cohort 1 n=12; A/Pbo=9/3] --> C1D[5 mg no titration QD 28 days]
        C2[Cohort 2 n=12; A/Pbo=9/3] --> C2D[10 mg no titration QD 28 days]
        C3[Cohort 3 n=12; A/Pbo=9/3] --> C3D[30 mg no titration QD 28 days]
        C4[Cohort 4 n=12; A/Pbo=9/3] --> C4T[50 mg with titration QD 28 days]
        
        subgraph Titration [MAD Cohort 4 titration]
            T1[10 mg Days 1-7] --> T2[25 mg Days 8-14]
            T2 --> T3[50 mg Days 15-28]
        end
        C4T --- Titration
    end

    subgraph Endpoints [Endpoints]
        PE[Primary endpoint] --- ST[Safety and tolerability]
        SE[Secondary endpoint] --- PK[Pharmacokinetics]
        EE[Exploratory PD endpoints] --- GL[Glucose OGTT and MMTT]
        EE --- BW[Body weight MAD]
    end
```
...
| SAD ECC5004 PK (Weight normalized concentration ng/mL)<br/>Time (hr) | SAD ECC5004 PK (Weight normalized concentration ng/mL)<br/>1 mg | SAD ECC5004 PK (Weight normalized concentration ng/mL)<br/>4 mg | SAD ECC5004 PK (Weight normalized concentration ng/mL)<br/>10 mg | SAD ECC5004 PK (Weight normalized concentration ng/mL)<br/>25 mg | SAD ECC5004 PK (Weight normalized concentration ng/mL)<br/>50 mg |
| -------------------------------------------------------------------- | --------------------------------------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- |
...
| Variables, n (%) \[E]            | ECC5004<br/>1 mg<br/>n = 6 | ECC5004<br/>4 mg<br/>n = 6 | ECC5004<br/>10 mg<br/>n = 6 | ECC5004<br/>25 mg<br/>n = 6 | Placebo<br/>n = 8 | Total<br/>n = 9 |
| -------------------------------- | -------------------------- | -------------------------- | --------------------------- | --------------------------- | ----------------- | --------------- |
| Cohort A1                        |                            |                            |                             |                             |                   |                 |
...
| Variables, n (%) \[E]            | ECC5004<br/>5 mg<br/>n = 9 | ECC5004<br/>10 mg<br/>n = 9 | ECC5004<br/>30 mg<br/>n = 10 | ECC5004<br/>50 mg (uptitrated)<br/>n = 10 | Placebo<br/>n = 13 | Total<br/>n = 51 |
| -------------------------------- | -------------------------- | --------------------------- | ---------------------------- | ----------------------------------------- | ------------------ | ---------------- |
...
| MAD ECC5004 PK (ng/mL)<br/>Dose | MAD ECC5004 PK (ng/mL)<br/>Day 1 Peak | MAD ECC5004 PK (ng/mL)<br/>Day 14 (Steady State) | MAD ECC5004 PK (ng/mL)<br/>Day 28 Peak |
| ------------------------------- | ------------------------------------- | ------------------------------------------------ | -------------------------------------- |
| 5 mg                            | 30                                    | 30                                               | 30                                     |
| 10 mg                           | 80                                    | 80                                               | 80                                     |
| 30 mg                           | 300                                   | 350                                              | 400                                    |
...
|                               | ECC5004<br/>5 mg<br/>n = 9 | ECC5004<br/>10 mg<br/>n = 9 | ECC5004<br/>30 mg<br/>n = 9 | ECC5004<br/>50 mg<br/>n = 10 |
| ----------------------------- | -------------------------- | --------------------------- | --------------------------- | ---------------------------- |
...
![Extracted image from page 1]({{ '/companies/eccogene_astrazeneca/elecoglipron/presentations_posters/OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1_images/img_p0_1.jpg' | relative_url }})

![Extracted image from page 1]({{ '/companies/eccogene_astrazeneca/elecoglipron/presentations_posters/OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1_images/page_1.jpg' | relative_url }})

![Extracted image from page 1]({{ '/companies/eccogene_astrazeneca/elecoglipron/presentations_posters/OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1_images/page_1_image_1_v2.jpg' | relative_url }})

![Extracted image from page 1]({{ '/companies/eccogene_astrazeneca/elecoglipron/presentations_posters/OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1_images/page_1_table_2_v2.jpg' | relative_url }})

![Extracted image from page 1]({{ '/companies/eccogene_astrazeneca/elecoglipron/presentations_posters/OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1_images/page_1_table_1_v2.jpg' | relative_url }})

![Extracted image from page 1]({{ '/companies/eccogene_astrazeneca/elecoglipron/presentations_posters/OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1_images/page_1_chart_4_v2.jpg' | relative_url }})

![Extracted image from page 1]({{ '/companies/eccogene_astrazeneca/elecoglipron/presentations_posters/OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1_images/page_1_chart_3_v2.jpg' | relative_url }})

![Extracted image from page 1]({{ '/companies/eccogene_astrazeneca/elecoglipron/presentations_posters/OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1_images/page_1_chart_1_v2.jpg' | relative_url }})

![Extracted image from page 1]({{ '/companies/eccogene_astrazeneca/elecoglipron/presentations_posters/OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1_images/page_1_chart_5_v2.jpg' | relative_url }})

![Extracted image from page 1]({{ '/companies/eccogene_astrazeneca/elecoglipron/presentations_posters/OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1_images/page_1_chart_2_v2.jpg' | relative_url }})

![Extracted image from page 1]({{ '/companies/eccogene_astrazeneca/elecoglipron/presentations_posters/OW-2024_ECC5004_SAD_MAD-Poster_FINAL_28Oct2024-1_images/page_1_image_2_v2.jpg' | relative_url }})
